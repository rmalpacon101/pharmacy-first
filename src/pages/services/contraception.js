  ...
  render() {
    return html`
      <div class="service-header">
        <div class="container">
          <h1 class="service-title">Pharmacy Contraception Service</h1>
          <p class="service-subtitle">Accessible contraceptive help and treatment through NHS Pharmacy services</p>
